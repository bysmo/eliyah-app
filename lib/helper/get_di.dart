import 'dart:convert';
import 'package:eliyah_express/features/brands/controllers/brands_controller.dart';
import 'package:eliyah_express/features/brands/domain/repositories/brands_repository.dart';
import 'package:eliyah_express/features/brands/domain/repositories/brands_repository_interface.dart';
import 'package:eliyah_express/features/brands/domain/services/brands_service.dart';
import 'package:eliyah_express/features/brands/domain/services/brands_service_interface.dart';
import 'package:eliyah_express/features/business/controllers/business_controller.dart';
import 'package:eliyah_express/features/business/domain/repositories/business_repo.dart';
import 'package:eliyah_express/features/business/domain/repositories/business_repo_interface.dart';
import 'package:eliyah_express/features/business/domain/services/business_service.dart';
import 'package:eliyah_express/features/business/domain/services/business_service_interface.dart';
import 'package:eliyah_express/features/coupon/domain/repositories/coupon_repository.dart';
import 'package:eliyah_express/features/coupon/domain/repositories/coupon_repository_interface.dart';
import 'package:eliyah_express/features/home/controllers/advertisement_controller.dart';
import 'package:eliyah_express/features/home/controllers/home_controller.dart';
import 'package:eliyah_express/features/home/domain/repositories/advertisement_repository.dart';
import 'package:eliyah_express/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:eliyah_express/features/home/domain/repositories/home_repository.dart';
import 'package:eliyah_express/features/home/domain/repositories/home_repository_interface.dart';
import 'package:eliyah_express/features/home/domain/services/advertisement_service.dart';
import 'package:eliyah_express/features/home/domain/services/advertisement_service_interface.dart';
import 'package:eliyah_express/features/home/domain/services/home_service.dart';
...
import 'package:eliyah_express/features/banner/domain/repositories/banner_repository.dart';
import 'package:eliyah_express/features/banner/domain/repositories/banner_repository_interface.dart';
import 'package:eliyah_express/features/banner/domain/services/banner_service.dart';
import 'package:eliyah_express/features/banner/domain/services/banner_service_interface.dart';
import 'package:eliyah_express/features/cart/domain/repositories/cart_repository.dart';
import 'package:eliyah_express/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:eliyah_express/features/cart/domain/services/cart_service.dart';
import 'package:eliyah_express/features/cart/domain/services/cart_service_interface.dart';
import 'package:eliyah_express/features/category/controllers/category_controller.dart';
import 'package:eliyah_express/features/category/domain/reposotories/category_repository.dart';
import 'package:eliyah_express/features/category/domain/reposotories/category_repository_interface.dart';
import 'package:eliyah_express/features/category/domain/services/category_service.dart';
import 'package:eliyah_express/features/category/domain/services/category_service_interface.dart';
import 'package:eliyah_express/features/chat/controllers/chat_controller.dart';
import 'package:eliyah_express/features/chat/domain/repositories/chat_repository.dart';
import 'package:eliyah_express/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:eliyah_express/features/chat/domain/services/chat_service.dart';
import 'package:eliyah_express/features/chat/domain/services/chat_service_interface.dart';
import 'package:eliyah_express/features/coupon/controllers/coupon_controller.dart';
import 'package:eliyah_express/features/coupon/domain/services/coupon_service.dart';
...
import 'package:eliyah_express/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:eliyah_express/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:eliyah_express/features/favourite/domain/services/favourite_service.dart';
...
import 'package:eliyah_express/features/flash_sale/domain/repositories/flash_sale_repository.dart';
import 'package:eliyah_express/features/flash_sale/domain/repositories/flash_sale_repository_interface.dart';
import 'package:eliyah_express/features/flash_sale/domain/services/flash_sale_service.dart';
...
import 'package:eliyah_express/features/html/domain/repositories/html_repository.dart';
import 'package:eliyah_express/features/html/domain/repositories/html_repository_interface.dart';
import 'package:eliyah_express/features/html/domain/services/html_service.dart';
...
import 'package:eliyah_express/features/item/domain/repositories/campaign_repository.dart';
import 'package:eliyah_express/features/item/domain/repositories/campaign_repository_interface.dart';
import 'package:eliyah_express/features/item/domain/repositories/item_repository.dart';
import 'package:eliyah_express/features/item/domain/repositories/item_repository_interface.dart';
import 'package:eliyah_express/features/item/domain/services/campaign_service.dart';
import 'package:eliyah_express/features/item/domain/services/campaign_service_interface.dart';
import 'package:eliyah_express/features/item/domain/services/item_service.dart';
...
import 'package:eliyah_express/features/language/domain/repository/language_repository.dart';
import 'package:eliyah_express/features/language/domain/repository/language_repository_interface.dart';
import 'package:eliyah_express/features/language/domain/service/language_service.dart';
import 'package:eliyah_express/features/language/domain/service/language_service_interface.dart';
...
import 'package:eliyah_express/features/address/domain/repositories/address_repository.dart';
import 'package:eliyah_express/features/address/domain/repositories/address_repository_interface.dart';
import 'package:eliyah_express/features/address/domain/services/address_service.dart';
...
import 'package:eliyah_express/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:eliyah_express/features/auth/controllers/store_registration_controller.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/auth_repository.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/auth_repository_interface.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/deliveryman_registration_repository.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/deliveryman_registration_repository_interface.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/store_registration_repository.dart';
import 'package:eliyah_express/features/auth/domain/reposotories/store_registration_repository_interface.dart';
import 'package:eliyah_express/features/auth/domain/services/auth_service.dart';
import 'package:eliyah_express/features/auth/domain/services/auth_service_interface.dart';
import 'package:eliyah_express/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:eliyah_express/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:eliyah_express/features/auth/domain/services/store_registration_service.dart';
import 'package:eliyah_express/features/auth/domain/services/store_registration_service_interface.dart';
import 'package:eliyah_express/features/checkout/controllers/checkout_controller.dart';
import 'package:eliyah_express/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:eliyah_express/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:eliyah_express/features/checkout/domain/services/checkout_service.dart';
import 'package:eliyah_express/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:eliyah_express/features/location/domain/repositories/location_repository.dart';
import 'package:eliyah_express/features/location/domain/repositories/location_repository_interface.dart';
import 'package:eliyah_express/features/location/domain/services/location_service.dart';
import 'package:eliyah_express/features/location/domain/services/location_service_interface.dart';
import 'package:eliyah_express/features/loyalty/controllers/loyalty_controller.dart';
import 'package:eliyah_express/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:eliyah_express/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:eliyah_express/features/loyalty/domain/services/loyalty_service.dart';
import 'package:eliyah_express/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:eliyah_express/features/notification/controllers/notification_controller.dart';
import 'package:eliyah_express/features/notification/domain/repository/notification_repository.dart';
import 'package:eliyah_express/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:eliyah_express/features/notification/domain/service/notification_service.dart';
import 'package:eliyah_express/features/notification/domain/service/notification_service_interface.dart';
import 'package:eliyah_express/features/onboard/controllers/onboard_controller.dart';
import 'package:eliyah_express/features/onboard/domain/repository/onboard_repository.dart';
import 'package:eliyah_express/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:eliyah_express/features/onboard/domain/service/onboard_service.dart';
...
import 'package:eliyah_express/features/order/domain/repositories/order_repository.dart';
import 'package:eliyah_express/features/order/domain/repositories/order_repository_interface.dart';
import 'package:eliyah_express/features/order/domain/services/order_service.dart';
...
import 'package:eliyah_express/features/parcel/domain/repositories/parcel_repository.dart';
import 'package:eliyah_express/features/parcel/domain/repositories/parcel_repository_interface.dart';
import 'package:eliyah_express/features/parcel/domain/services/parcel_service.dart';
import 'package:eliyah_express/features/parcel/domain/services/parcel_service_interface.dart';
import 'package:eliyah_express/features/payment/controllers/payment_controller.dart';
import 'package:eliyah_express/features/payment/domain/repositories/payement_repository.dart';
import 'package:eliyah_express/features/payment/domain/repositories/payment_repository_interface.dart';
import 'package:eliyah_express/features/payment/domain/services/payment_service.dart';
...
import 'package:eliyah_express/features/profile/domain/repositories/profile_repository.dart';
import 'package:eliyah_express/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:eliyah_express/features/profile/domain/services/profile_service.dart';
...
import 'package:eliyah_express/features/review/domain/repositories/review_repository.dart';
import 'package:eliyah_express/features/review/domain/repositories/review_repository_interface.dart';
import 'package:eliyah_express/features/review/domain/services/review_service.dart';
import 'package:eliyah_express/features/review/domain/services/review_service_interface.dart';
import 'package:eliyah_express/features/search/controllers/search_controller.dart';
import 'package:eliyah_express/features/search/domain/repositories/search_repository.dart';
import 'package:eliyah_express/features/search/domain/repositories/search_repository_interface.dart';
import 'package:eliyah_express/features/search/domain/services/search_service.dart';
...
import 'package:eliyah_express/features/splash/domain/repositories/splash_repository.dart';
import 'package:eliyah_express/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:eliyah_express/features/splash/domain/services/splash_service.dart';
...
import 'package:eliyah_express/features/store/domain/repositories/store_repository.dart';
import 'package:eliyah_express/features/store/domain/repositories/store_repository_interface.dart';
import 'package:eliyah_express/features/store/domain/services/store_service.dart';
import 'package:eliyah_express/features/store/domain/services/store_service_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_location_screen/controller/taxi_location_controller.dart';
import 'package:eliyah_express/features/rental_module/home/controllers/taxi_home_controller.dart';
import 'package:eliyah_express/features/rental_module/home/domain/repositories/taxi_home_repository.dart';
import 'package:eliyah_express/features/rental_module/home/domain/repositories/taxi_home_repository_interface.dart';
import 'package:eliyah_express/features/rental_module/home/domain/services/taxi_home_service.dart';
import 'package:eliyah_express/features/rental_module/home/domain/services/taxi_home_service_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_cart_screen/controllers/taxi_cart_controller.dart';
import 'package:eliyah_express/features/rental_module/rental_cart_screen/domain/repository/taxi_cart_repository.dart';
import 'package:eliyah_express/features/rental_module/rental_cart_screen/domain/repository/taxi_cart_repository_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_cart_screen/domain/services/taxi_cart_service.dart';
import 'package:eliyah_express/features/rental_module/rental_cart_screen/domain/services/taxi_cart_service_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_favourite/controllers/taxi_favourite_controller.dart';
import 'package:eliyah_express/features/rental_module/rental_favourite/domain/repositories/taxi_favourite_repository.dart';
...
import 'package:eliyah_express/features/rental_module/rental_favourite/domain/services/taxi_favourite_service.dart';
import 'package:eliyah_express/features/rental_module/rental_favourite/domain/services/taxi_favourite_service_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_location_screen/domain/repository/taxi_repository.dart';
...
import 'package:eliyah_express/features/rental_module/rental_location_screen/domain/services/taxi_location_service.dart';
import 'package:eliyah_express/features/rental_module/rental_location_screen/domain/services/taxi_location_service_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_order/controllers/taxi_order_controller.dart';
import 'package:eliyah_express/features/rental_module/rental_order/domain/repository/taxi_order_repository.dart';
import 'package:eliyah_express/features/rental_module/rental_order/domain/repository/taxi_order_repository_interface.dart';
import 'package:eliyah_express/features/rental_module/rental_order/domain/services/taxi_order_service.dart';
import 'package:eliyah_express/features/rental_module/rental_order/domain/services/taxi_order_service_interface.dart';
import 'package:eliyah_express/features/rental_module/vendor/controllers/taxi_vendor_controller.dart';
import 'package:eliyah_express/features/rental_module/vendor/domain/repositories/taxi_vendor_repository.dart';
import 'package:eliyah_express/features/rental_module/vendor/domain/repositories/taxi_vendor_repository_interface.dart';
import 'package:eliyah_express/features/rental_module/vendor/domain/services/taxi_vendor_service.dart';
import 'package:eliyah_express/features/rental_module/vendor/domain/services/taxi_vendor_service_interface.dart';
import 'package:eliyah_express/features/verification/controllers/verification_controller.dart';
import 'package:eliyah_express/features/verification/domein/reposotories/verification_repository.dart';
import 'package:eliyah_express/features/verification/domein/reposotories/verification_repository_interface.dart';
import 'package:eliyah_express/features/verification/domein/services/verification_service.dart';
import 'package:eliyah_express/features/verification/domein/services/verification_service_interface.dart';
import 'package:eliyah_express/features/wallet/controllers/wallet_controller.dart';
import 'package:eliyah_express/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:eliyah_express/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:eliyah_express/features/wallet/domain/services/wallet_service.dart';
